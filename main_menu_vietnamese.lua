local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/VanThanhIOS/VanThanhKamuy/refs/heads/main/VanThanhIOS.lua.txt"))() -- LIBRARY


local Window = Library:CreateWindow('Menu : Việt Hoá') -- CREATE WINDOW

local Tab = { -- CREATE TABS
    Tab_1 = Window:addTab('#Trang Chính'),
    Tab_Setting = Window:addTab('#Tùy Chỉnh'),
    Tab_2 = Window:addTab('#Khai Thác Chính'),
    Tab_SubFarm = Window:addTab('#Khai Thác Phụ'),
    Tab_3 = Window:addTab('#Công Việc'),
    Tab_Sea = Window:addTab('#Sự Kiện Biển'),
    Tab_RaceV4 = Window:addTab('#Tộc Phiên Bản 4'),
    Tab_4 = Window:addTab('#Đột Kích'),
    Tab_Combat = Window:addTab('#Đấu Người'),
    Tab_5 = Window:addTab('#Trạng Thái & Dịch Chuyển'),
    Tab_6 = Window:addTab('#Mua Sắm'),
    Tab_7 = Window:addTab('#Tùy Chọn Khác')
    
}

local Home_Right = Tab.Tab_1:addSection() -- HOME RIGHT SECTION
local Main_Home = Home_Right:addMenu("#Trang Chính")

getgenv().WalkSpeedValue = 26
Main_Home:addTextbox("Tăng Tốc Độ", getgenv().WalkSpeedValue, function(speedfunc)
    getgenv().WalkSpeedValue = speedfunc
    if getgenv().WalkSpeedValue then
        local Player = game:service'Người Chơi'.LocalPlayer
        Player.Character.Humanoid:GetPropertyChangedSignal'Tốc độ đi':Connect(function()
...
Main_Home:addTextbox("Hack Nhảy Cao", getgenv().JumpValue, function(jumpfunc)
    getgenv().JumpValue = jumpfunc
    if getgenv().JumpValue then
        game:GetService("Người Chơi").LocalPlayer.Character.Humanoid.JumpPower = getgenv().JumpValue
    end
end)

Main_Home:addToggle("Nhảy Vô Hạn", InfiniteJumpEnabled, function(Value)
...
Main_Home:addToggle("Chống AFK", getgenv().AntiAFK, function(Value)
...
Main_Home:addToggle("Chống Kick", getgenv().AntiKickClient, function(Value)
...
Main_Home:addButton("Tăng FPS", function()
...
Main_Home:addButton("Đổi Sever", function()
    game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
end)

Main_Home:addButton("Sever Vắng", function()
    Hop()
end)
function Hop()
...
if game:GetService("Players").LocalPlayer.PlayerGui.Main:FindFirstChild("Chọn Phe") then
    repeat wait()
...
local Main_Setting = Setting_Left:addMenu('#Cài Đặt Chính')

local WeaponList = {"Melee","Trái Cây","Kiếm","Súng"}
...
task.spawn(function()
    while wait() do
        pcall(function()
            ...
            elseif SelectWeaponFarm == "Kiếm" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            ...
            elseif SelectWeaponFarm == "Trái Cây" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            ...
            elseif SelectWeaponFarm == "Súng" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
...
AutoFarmType = "Above"
Main_Setting:addDropdown("Chọn Kiểu Farm", AutoFarmType, FarmTable, function(Value)
    AutoFarmType = Value
end)
spawn(function()
    while wait() do
...
--// SEA FARM
local Sea_Farm = Sea_Left:addMenu('#Sự Kiện Biển')
...
local IslandInfo = Race_V4_Left:addMenu("#Trạng Thái Đảo")

local MirageCheck = IslandInfo:addLabel("")
spawn(function()
	while task.wait() do
		if game.Workspace._WorldOrigin.Locations:FindFirstChild("Đảo Bí Ẩn") then
            MirageCheck:Refresh("Đảo Bí Ẩn : Đã Xuất Hiện")
        else
            MirageCheck:Refresh("Đảo Bí Ẩn : Chưa Xuất Hiện")
        end
	end
end)
...
spawn(function()
	while task.wait() do
		if game.Workspace._WorldOrigin.Locations:FindFirstChild("Đảo Kitsune ") then
            KitsuneCheck:Refresh("Đảo Kitsune  : Đã Xuất Hiện")
        else
            KitsuneCheck:Refresh("Đảo Kitsune  : Chưa Xuất Hiện")
        end
	end
end)
...
spawn(function()
    while wait() do
        if game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
            MoonCheck:Refresh("Trạng Thái Trăng : Đạt 100%")
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
            MoonCheck:Refresh("Trạng Thái Trăng: Đạt 75%")
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
            MoonCheck:Refresh("Trạng Thái Trăng : Đạt  50%")
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
            MoonCheck:Refresh("Trạng Thái Trăng : Đạt 25%")
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
            MoonCheck:Refresh("Trạng Thái Trăng : Đạt 15%")
        else
            MoonCheck:Refresh("Trạng Thái Trăng : Đạt 0%")
        end
    end
end)
...
----------------------------------------------------//----------------------------------------------------
--// Mirage Island
local Mirage_Island = Race_V4_Left:addMenu('#Đảo Bí Ẩn')

Mirage_Island:addToggle("ESP Đảo Bí Ẩn", MirageIslandEsp, function(Value)
...
local Mastery_Farm = Farm_Right:addMenu('#Farm Mastery')
KillPercent = 25
Mastery_Farm:addTextbox('Skill Percentace %', KillPercent, function(Value)
    KillPercent = Value
end)

local MasteryType = {'Nhiệm Vụ', 'Không Nhiệm Vụ', 'Ở Gần', 'Xương', 'Ecto', 'Nữ Hoàng Bánh'}
SelectedMethodMastery = "Nhiệm Vụ"
Mastery_Farm:addDropdown('Select Method', SelectedMethodMastery, MasteryType, function(Value)
    SelectedMethodMastery = Value
end)

Mastery_Farm:addToggle('Auto Farm  Mastery Trái Dứng', DevilMastery_Farm, function(Value)
                    ...
                    if v.Name == Mastery_Farm_Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health <= v.Humanoid.MaxHealth * KillPercent / 100 then
                        repeat game:GetService("RunService").Heartbeat:wait()
                            ...
                            if game:GetService("Players").LocalPlayer.Character:FindFirstChild(CurrentEquipDevilFruit) then
                                ...
                                local plr = game:GetService("Players").LocalPlayer
                                if _G.SkillZ and DevilFruitMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "Z", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "Z", false, game)
                                end
                                if _G.SkillX and DevilFruitMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "X", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "X", false, game)
                                end
                                if _G.SkillC and DevilFruitMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "C", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "C", false, game)
                                end
                                if _G.SkillV and DevilFruitMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "V", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "V", false, game)
                                end
                                if _G.SkillF and DevilFruitMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:GetService("VirtualInputManager"):SendKeyEvent(true, "F", false, game)
                                    wait(.1)
                                    game:GetService("VirtualInputManager"):SendKeyEvent(false, "F", false, game)
                                end
                    ...
                    if v.Name == Mastery_Farm_Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health <= v.Humanoid.MaxHealth * KillPercent / 100 then
                        repeat game:GetService("RunService").Heartbeat:wait()
                            ...
                            if game:GetService("Players").LocalPlayer.Character:FindFirstChild(CurrentEquipGun) then
                                ...
                                local plr = game:GetService("Players").LocalPlayer
                                if _G.SkillZ and GunMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "Z", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "Z", false, game)
                                end
                                if _G.SkillX and GunMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "X", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "X", false, game)
                                end
                                if _G.SkillC and GunMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "C", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "C", false, game)
                                end
                                if _G.SkillV and GunMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "V", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "V", false, game)
                                end
                                if _G.SkillF and GunMastery >= 1 and (v.HumanoidRootPart.Position - plr.Character.HumanoidRootPart.Position).Magnitude < 50 then
                                    game:GetService("VirtualInputManager"):SendKeyEvent(true, "F", false, game)
                                    wait(.1)
                                    game:GetService("VirtualInputManager"):SendKeyEvent(false, "F", false, game)
                                end
...
spawn(function()
    while wait() do
        ...
        EliteProgress:Refresh("Đã Giết Elite Boss Được: " .. progelit)
        if game:GetService('ReplicatedStorage'):FindFirstChild('Diablo') or game:GetService('ReplicatedStorage'):FindFirstChild('Deandre') or game:GetService('ReplicatedStorage'):FindFirstChild('Urban') then
            EliteStatus:Refresh("Trạng Thái Boss : Đã Xuất Hiện.")
        elseif not game:GetService('ReplicatedStorage'):FindFirstChild('Diablo') or not game:GetService('ReplicatedStorage'):FindFirstChild('Deandre') or not game:GetService('ReplicatedStorage'):FindFirstChild('Urban') then
            EliteStatus:Refresh("Trạng Thái Boss : Chưa Xuất Hiện.")
        end
    end
end)
...
function AutoGrabChest()
    ...
    for i,v in pairs(game:GetService("Workspace").ChestModels:GetChildren()) do 
        if v.Name == "SilverChest" or v.Name == "GoldChest" or v.Name == "DiamondChest" then
...
----------------------------------------------------//----------------------------------------------------
--// SWORD QUEST
local Sword_Wuest = Quest_Left:addMenu('#Kiếm')
...
spawn(function()
    while task.wait() do
        if GetWeaponInventory("Tushita") == true then
            TushitaSword:Refresh("Kiếm Tushita  : Đã Có")
        elseif GetWeaponInventory("Tushita") == false then
            TushitaSword:Refresh("Kiếm Tushita  : Chưa Có")
        end

        if GetWeaponInventory("Yama") == true then
            YamaSword:Refresh("Kiếm Yama  : Đã Có")
        elseif GetWeaponInventory("Yama") == false then
            YamaSword:Refresh("Kiếm Yama  : Chưa Có")
        end
    end
end)
...
----------------------------------------------------//----------------------------------------------------
--// Other Quest
local Other_Quest = Quest_Right:addMenu('#Khác')
...
--// Law Raid
local Law_Raids = Raid_Left:addMenu('#Raids Law')

local RaidWeaponList = {"Melee", "Kiếm", "Trái Dứng", "Súng"}
RaidSelectedWeapon = "Melee"
Law_Raids:addDropdown("Chọn Vũ Khí", RaidSelectedWeapon, RaidWeaponList, function(Value)
...
task.spawn(function()
    while wait() do
        pcall(function()
            ...
            elseif RaidSelectedWeapon == "Kiếm" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                    if v.ToolTip == "Sword" then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
                            SelectWeaponRaid = v.Name
            ...
            elseif RaidSelectedWeapon == "Trái Dứng" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                    if v.ToolTip == "Blox Fruit" then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
                            SelectWeaponRaid = v.Name
            ...
            elseif RaidSelectedWeapon == "Súng" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                    if v.ToolTip == "Gun" then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
                            SelectWeaponRaid = v.Name
...
DisRaid = 70
Law_Raids:addTextbox("Phạm Vi Farm", DisRaid, function(Value)
    DisRaid = Value
end)

Law_Raids:addToggle("Mua Chips Law", Auto_Buy_Law_Chip, function(Value)
...
Law_Raids:addToggle("Bắt Đầu Raids Law", Auto_Start_Law_Dungeon, function(Value)
...
Law_Raids:addToggle('Tự Động Giết Law', BossRaid, function(Value)
    BossRaid = Value
...
local Raids = Raid_Right:addMenu('#Đột Kích')

local Chips = {"Lửa","Băng","Chấn Động","Ánh Sáng","Bóng Tối","Nhện","Lôi","Dung Nham","Phật","Cát","Phượng Hoàng","Bột"}

Raids:addDropdown("Chọn Chips", SelectChip, Chips, function(Value)
    SelectChip = Value
end)

Raids:addToggle("Tự Động Mua Chip", AutoBuySpecialChip, function(Value)
...
Raids:addToggle("Bắt Đầu Raids", AutoSTartRaids, function(Value)
...
Raids:addToggle('Kill Aura', RaidAura, function(Value)
    RaidAura = Value
end)
spawn(function()
...
Raids:addToggle('Đảo Tiếp Theo', AutoNextIsland, function(Value)
...
Raids:addToggle('Tự Động Thức Tỉnh', AutoAwakenAbilities, function(Value)
...
Raids:addButton("Dịch Chuyển Đến Phòng Thí Nghiệm", function()
    if Second_Sea then
...
local Setting_Pvp = Pvp_Left:addMenu('#Cài Đặt PVP')

local Current = Setting_Pvp:addLabel("Bounty Hiện Tại: ")
